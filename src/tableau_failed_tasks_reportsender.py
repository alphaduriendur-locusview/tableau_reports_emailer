...
def download_and_send(workbook):
    ...
    create_out_dir()
    emails = create_email_obj(read_email_list())
    ...
    try:
        ...
        for view in workbook.views:
            ...
            with open(download_file, 'wb') as f:
                f.write(view.pdf)
                print("Download Successfull! File located at - {}\n".format(download_file))
                if view.name in emails:
                    print("Attempting to send it as an email.")
                    weekly_email = NoticeEmail(msg_subject="Weekly Failed Task Report - " + current_date.isoformat(),
